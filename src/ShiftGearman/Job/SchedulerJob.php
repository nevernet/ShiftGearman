...
/**
 * Scheduler job
 * This job handles passing jobs for execution to gearman from scheduler
 * queue.
 *
 * @category    Projectshift
 * @package     ShiftGearman
...
class SchedulerJob extends AbstractJob
{
    ...
    {
        $this->setName('shiftgearman.scheduler');
        $this->setDescription('Executes scheduler jobs in background');
    }
